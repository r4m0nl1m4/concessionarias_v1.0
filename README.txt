...
├─── Naut 1                                 //NÚMERO DE AUTOMÓVEIS DO ESTOQUE
├─── ProT 1                                 //PRODUÇÃO TRIMESTRAL DE AUTOMÓVEIS DA CONCESSIONÁRIA
├─── Automóvel                              //EXIBIÇÃO DE AUTOMÓVEL(IS) CADASTRADO(S)
...
├── Concessionária Volkswagen do Brasil produziu 1 automovel(is) no último trimestre.
├─── Automóvel
├──── Marca Volkswagen Fusca
├──── Preço R$ 10000.00
├──── Chass 98765
